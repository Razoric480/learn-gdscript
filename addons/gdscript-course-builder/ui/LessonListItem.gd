...
func _update_theme() -> void:
	...
	_lesson_name_label.add_theme_font_override("font", get_theme_font("title", "EditorFonts"))
	_lesson_path_label.add_theme_color_override("font_color", get_theme_color("disabled_font_color", "Editor"))
