...
func print_error(
	thing_to_print: Variant, file_name: String, line_nb: int = 0, character: int = 0, error_code: int = -1
) -> void:
...
func print_warning(
	thing_to_print: Variant, file_name: String, line_nb: int = 0, character: int = 0, warning_code: int = -1
) -> void:
